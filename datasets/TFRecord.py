...
def createTFRecord(filename, mapfile):
    ...
    '''
    class_map = {}
    data_dir = '/Users/xiaofeng/Code/normal_code/data_make/my_data_to_tf'
    classes = {'/ori', '/new'}
    # 输出TFRecord文件的地址
...
if __name__ == "__main__":
    ...
    mapfile = '/Users/xiaofeng/Code/normal_code/data_make/my_data_to_tf/classmap.txt'
    train_filename = '/Users/xiaofeng/Code/normal_code/data_make/my_data_to_tf/train.tfrecords'
    createTFRecord(train_filename, mapfile)
    test_filename = '/Users/xiaofeng/Code/normal_code/data_make/my_data_to_tf/test.tfrecords'
